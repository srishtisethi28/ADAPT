...
export const ExploreShop = ({ category, setCategory }) => {
  return (
    <div id='explore-shop' className="h-[34rem] w-full rounded-3xl mt-14 bg-[url('/hero.png')]  " >
      <div className="relative  mr-5 ml-5 hidden lg:block">
        <img
      ...
      <div className="flex flex-col flex-wrap  md:w-[75%] md:top-1/4 xl:w-[60%] lg:w-[40%] 1216px:top-[38%] mx-auto lg:top-[35%] sm:top-[38%] top-[30%] sm:w-[90%] relative  text-center justify-center items-center gap-4 lg:gap-2 animate-fadeIn 0.3s z-100" >
        <h2 className=" text-[1.5rem] md:text-[2.6rem] lg:text-[1.3rem] xl:text-[2.2rem]  font-semibold text-[#404556] ">Assistive Tools for Effortless Communication</h2>
        <p className="w-[60%] lg:w-[75%] md:w-[75%] text-[#404556] text-[0.9rem] md:text-[1rem] lg:text-[0.8rem] xl:text-[1rem]  ">Explore innovative speech-to-text and text-to-speech tools designed to enhance accessibility and make digital interaction seamless for everyone</p>
        <button className=' bg-rose-600 rounded-3xl p-2 px-4 text-white font-semibold hover:bg-[#404556]  w-32 transition-all duration-400 ease-in-out flex gap-3 items-center group'>
                  Try Now
                  <img src={assets.arrowhover} className='w-5' alt="Arrow" />
                </button>
      </div>
    </div>
  );
