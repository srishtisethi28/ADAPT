...
export const ExploreItems = ({ category, setCategory }) => {
  return (
    <div id='explore-items' className="flex flex-col gap-4 mt-20 justify-center items-center text-center px-4">
      <h1 className='xl:text-5xl sm:text-4xl xs:text-3xl text-5xl text-[#404556] font-semibold'>Top Selling Products</h1>
      <p className='xl:text-2xl text-xl sm:text-lg text-[#404556] mb-4 max-w-2xl'>
            ...
            <img 
              className={
                category === item.shop_name
                  ? 'w-44 h-44 sm:w-36 sm:h-36 xs:w-28 xs:h-28 xl:w-48 xl:h-48 rounded-full shadow-lg shadow-[rgba(183,150,185,0.54)] hover:scale-110 transition-all duration-300 ease-in-out p-2 bg-gradient-to-b from-[#fc97b9] via-[#e2729b] to-[#2d2d2d]'
                  : 'w-44 h-44 sm:w-36 sm:h-36 xs:w-28 xs:h-28 xl:w-48 xl:h-48 rounded-full shadow-lg shadow-[rgba(183,150,185,0.54)] hover:scale-110 transition-all duration-300 ease-in-out p-2 bg-gradient-to-b from-[#fc97b9] via-[#e2729b] to-[#2d2d2d]'
              } 
              src={item.shop_img} 
              alt={item.shop_name} 
