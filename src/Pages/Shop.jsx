  ...
  return (
    <div className=' mt-[8.5rem] w-full '>
      <div className="heading flex flex-col justify-center items-center gap-2">
        <h2 className='text-5xl font-semibold text-[#404556]'>Our Products</h2>
        <p className='text-xl text-[#60687f]'>Discover a range of products designed to make life easier and more accessible for everyone</p>
